...
- #2515 Added `terminate()` and `send_signal()` methods
...
- [fecf9f][fecf9f] tubes.ssh.process() no longer requires python 2 installed on remote (still requires python, though)
